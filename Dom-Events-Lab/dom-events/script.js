...
const countElement = document.getElementById('count'); //iskame da vzemem count-a ot diva
...
function onIncrement(event) {
    countElement.textContent = Number(countElement.textContent) + 1; //vzemi mi stariq text content i kum nego dobavi oshte edno
}
