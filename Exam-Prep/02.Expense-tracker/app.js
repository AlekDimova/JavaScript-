...
function solve() {
    ...
    addButtonElement.addEventListener('click', () => {
        ...
        editButtonElement.addEventListener('click', () => {
            ...
            // Clear preview (should remove event listeners also prakticno e hubavo)
            expenseLiElement.remove();

            // Enable add button
            addButtonElement.removeAttribute('disabled'); //pak da stane aktiven add buttona
        });
    ...
    //tuk si pisem funkcija za da kreirame dopolnitelen elementi
