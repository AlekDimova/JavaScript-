...
const loadMeals = async () => {
    ...
    for (const meal of Object.values(data)) {
        ...
        //!!!da si vzemem i drugite 2 buttona change i delete
        // Attach on change button
...
//dobavame event na load buttona
